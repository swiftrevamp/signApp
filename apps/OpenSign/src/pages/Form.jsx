...
const Forms = (props) => {
  ...
  const extUserData =
    ...
    console.log(extUserData,"extUserdata")
  const sendinorder =
  ...
  const handleFileInput = async (e) => {
    ...
    try {
      ...
      console.log(files,"fiel slectted self")
  ...
  function isValidURL(value) {
    try {
      ...
      console.log(url,"tesetr url")

      console.log(url.protocol === "https:" || url.protocol === "http:","Url")
  ...
  const handleSubmit = async (e) => {
    ...
    e.stopPropagation();
    console.log(fileload,"fileupload")
    if (fileupload) {
